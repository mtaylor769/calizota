...
<p class="ec_cart_success_continue_shopping_button">
	...
	<?php if( $GLOBALS['ec_cart_data']->cart_data->is_guest == "" ){
		echo "<a href=\"" . $this->account_page . $this->permalink_divider . "ec_page=order_details&order_id=" . $order_id . "\">View Order</a>";
	}else{
		echo "<a href=\"" . $this->account_page . $this->permalink_divider . "ec_page=order_details&order_id=" . $order_id . "&guest_key=" . $GLOBALS['ec_cart_data']->cart_data->guest_key . "\">View Order</a>";
	}
	?>
    
    <a href="<?php echo $this->store_page; ?>"><?php echo $GLOBALS['language']->get_text( 'cart', 'cart_continue_shopping' ); ?></a>
</p>
