                    ...
                    <tbody>
                        <tr>
                            <td class="ec_minus_column">
                                <input type="button" value="-" class="ec_minus" onclick="ec_minus_quantity( '<?php echo $cart->cart[$cartitem_index]->cartitem_id; ?>' );" /></td>
                            ...
                            <td class="ec_plus_column"><input type="button" value="+" class="ec_plus" onclick="ec_plus_quantity( '<?php echo $cart->cart[$cartitem_index]->cartitem_id; ?>' );" /></td>
                        </tr>
                        <tr>
