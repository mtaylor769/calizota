                                    ...
                                    <td width='269' class='style22'>
                                        <table class="full_width" width="560" style="width:560px; mso-cellspacing: 0px; mso-padding-alt: 0px 0px 0px 0px; margin:0 auto;" align="center" border="0" cellpadding="0" cellspacing="0"><!-- start text content -->
                                            ...
                                            <tr>
                                                <td width="100">
                                                    <?php
                                                    if( file_exists( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $tempcart_row->image1 ) && !is_dir( WP_PLUGIN_DIR . "/wp-easycart-data/products/pics1/" . $tempcart_row->image1 ) ){
                                                        $img_url = plugins_url( "wp-easycart-data/products/pics1/" . $tempcart_row->image1 );
                                                        
                                                    ?>
                                                    <div style="ec_lineitem_image"><img src="<?php echo str_replace( "https://", "http://", $img_url ); ?>" width="70" alt="<?php echo $tempcart_row->title; ?>" /></div>
                                                    <?php }?>
                                                </td>
                                                <td class='style20' width="350">
												<?php 
													echo $tempcart_row->title;
													if( $tempcart_row->optionitem_id_1 ){
														...
														echo "<br />" . $optionitem->optionitem_name;
													}
