		...
		<div class="ec_admin_video_padding">
    		<div class="ec_admin_video_holder">
    	    	<div class="ec_admin_video">
    	        	...
    	        	<div class="ec_admin_video_close"><a href="<?php echo $this->cartpage . $this->permalink_divider . "ec_admin_action=hide-video"; ?>" onclick="ec_admin_close_video_screen( ); return false;">x</a></div>
                </div>
    	    </div>
    	</div>
	</div>
