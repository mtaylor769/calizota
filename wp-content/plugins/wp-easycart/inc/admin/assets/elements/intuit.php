...
<script type="text/javascript">
    intuit.ipp.anywhere.setup({
            grantUrl: '<?php echo get_admin_url( ); ?>admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=payment-settings&ec_wpeasycart_intuit_authroize=true&start=true',
            datasources: {
                 quickbooks : false,
                 payments : true
           },
...
<div class="ec_payment_type_holder<?php if( get_option( 'ec_option_payment_process_method' ) != "intuit" ){ echo '_inactive'; } ?>" id="intuit">
    
    <div class="ec_payment_type_row"><a href="http://v3docs.wpeasycart.com/3.0.0/settings/payment_information.php#intuitpayments" target="_blank">Start by Viewing the Intuit Payments Documentation</a></div>
    
    <?php if( get_option( 'ec_option_intuit_realm_id' ) && get_option ( 'ec_option_intuit_access_token_secret' ) ){ ?>
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Intuit Status:</span><span class="ec_payment_type_row_input">You've been authorized - <a href="admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=payment-settings&ec_wpeasycart_intuit_reauthroize=true">Renew Authorization</a> | <a href="admin.php?page=ec_adminv2&ec_page=store-setup&ec_panel=payment-settings&ec_wpeasycart_intuit_disconnect=true">Disconnect</a></span></div>
    
	<?php }else if( get_option('ec_option_intuit_app_token') != "" && get_option('ec_option_intuit_consumer_key') != "" && get_option('ec_option_intuit_consumer_secret') != "" ){ ?>
	<div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Connect to Intuit:</span><span class="ec_payment_type_row_input"><ipp:connectToIntuit></ipp:connectToIntuit></span></div>
	<?php }?>
    
	<div class="ec_payment_type_row"><span class="ec_payment_type_row_label">App Token:</span><span class="ec_payment_type_row_input"><input name="ec_option_intuit_app_token" id="ec_option_intuit_app_token" type="text" value="<?php echo stripslashes( get_option( 'ec_option_intuit_app_token' ) ); ?>" style="width:250px;" /></span></div>
    
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">OAuth Consumer Key:</span><span class="ec_payment_type_row_input"><input name="ec_option_intuit_consumer_key" id="ec_option_intuit_consumer_key" type="text" value="<?php echo stripslashes( get_option('ec_option_intuit_consumer_key' ) ); ?>" style="width:250px;" /></span></div>
    
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">OAuth Consumer Secret:</span><span class="ec_payment_type_row_input"><input name="ec_option_intuit_consumer_secret" id="ec_option_intuit_consumer_secret" type="text" value="<?php echo stripslashes( get_option('ec_option_intuit_consumer_secret' ) ); ?>" style="width:250px;" /></span></div>

	<div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Currency Code:</span><span class="ec_payment_type_row_input"><select name="ec_option_intuit_currency" id="ec_option_intuit_currency">
    ...
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Sandbox Mode:</span><span class="ec_payment_type_row_input"><select name="ec_option_intuit_test_mode" id="ec_option_intuit_test_mode">
                        <option value="1" <?php if (get_option('ec_option_intuit_test_mode') == 1) echo ' selected'; ?>>Yes</option>
                        <option value="0" <?php if (get_option('ec_option_intuit_test_mode') == 0) echo ' selected'; ?>>No</option>
                      </select></span></div>
