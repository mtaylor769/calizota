<div class="ec_payment_type_holder<?php if( get_option( 'ec_option_payment_process_method' ) != "stripe" ){ echo '_inactive'; } ?>" id="stripe">
	...
	<div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Stripe Secret API Key:</span><span class="ec_payment_type_row_input"><input name="ec_option_stripe_api_key" id="ec_option_stripe_api_key" type="text" value="<?php echo stripslashes( get_option( 'ec_option_stripe_api_key' ) ); ?>" style="width:250px;" /></span></div>
    ...
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label"><input name="ec_option_stripe_order_create_customer" id="ec_option_stripe_order_create_customer" type="checkbox" value="1"<?php if( get_option( 'ec_option_stripe_order_create_customer' ) == '1' ){ ?> checked="checked"<?php }?> /> Create Customer on Order:</span><span class="ec_payment_type_row_input"></span></div>
