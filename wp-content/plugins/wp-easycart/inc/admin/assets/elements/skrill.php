<div class="ec_payment_type_holder<?php if( get_option( 'ec_option_payment_third_party' ) != "skrill" ){ echo '_inactive'; } ?>" id="skrill">
    ...
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Skrill Merchant ID (Customer ID):</span><span class="ec_payment_type_row_input"><input name="ec_option_skrill_merchant_id"  id="ec_option_skrill_merchant_id" type="text" value="<?php echo stripslashes( get_option( 'ec_option_skrill_merchant_id' ) ); ?>" style="width:250px;" /></span></div>
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Skrill Company Name:</span><span class="ec_payment_type_row_input"><input name="ec_option_skrill_company_name"  id="ec_option_skrill_company_name" type="text" value="<?php echo stripslashes( get_option( 'ec_option_skrill_company_name' ) ); ?>" style="width:250px;" /></span></div>
    <div class="ec_payment_type_row"><span class="ec_payment_type_row_label">Skrill Email:</span><span class="ec_payment_type_row_input"><input name="ec_option_skrill_email" id="ec_option_skrill_email"  type="text" value="<?php echo stripslashes( get_option( 'ec_option_skrill_email' ) ); ?>" style="width:250px;" /></span></div>
