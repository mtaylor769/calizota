...
if( !isset( $_COOKIE['ec_cart_id'] ) || ( isset( $_COOKIE['ec_cart_id'] ) && $_COOKIE['ec_cart_id'] == "deleted" ) ){ // No Cookie, Set One
	
	if( !isset( $_SESSION['ec_cart_id'] ) || ( isset( $_SESSION['ec_cart_id'] ) && $_SESSION['ec_cart_id'] == "deleted" ) ){
		global $wpdb;
